...
#ifndef INFORMATIONSECURITY_KALYNA_CONSTANTS_H
#define INFORMATIONSECURITY_KALYNA_CONSTANTS_H

typedef unsigned long long WORD_TYPE;
typedef unsigned char BYTE_TYPE;

BYTE_TYPE mdsMatrix[8][8] = {
...
#endif //INFORMATIONSECURITY_CONSTANTS_H
